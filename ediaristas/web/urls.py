...
from .views import cadastrar_diarista, listar_diaristas, cadastrar_contratante, listar_contratantes, editar_diarista, remover_diarista
...
urlpatterns = [
    ...
    path('cadastrar_contratante', cadastrar_contratante, name='cadastrar_contratante'),
    path('listar_contratantes', listar_contratantes, name='listar_contratantes')
]